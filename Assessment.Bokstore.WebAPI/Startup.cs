...
namespace Assessment.Bokstore.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                config.UseSqlServer(Configuration.GetConnectionString("BookstoreDbContext"));
            });
            ...
            services.AddScoped<IBindBookService, BindBookService>();
        }
